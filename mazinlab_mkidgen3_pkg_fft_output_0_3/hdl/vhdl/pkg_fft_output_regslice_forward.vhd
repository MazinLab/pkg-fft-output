...
entity pkg_fft_output_regslice_forward is
...
architecture behav of pkg_fft_output_regslice_forward is
    ...
    component pkg_fft_output_regslice_obuf IS
    generic (
        W : INTEGER );
    port (
        clk : IN STD_LOGIC;
...
begin
    ...
    regslice_obuf_inst : component pkg_fft_output_regslice_obuf
    generic map (
        W => W)
    port map (
        clk => ap_clk,
...
entity pkg_fft_output_regslice_forward_w1 is
...
architecture behav of pkg_fft_output_regslice_forward_w1 is
...
entity pkg_fft_output_regslice_obuf is
...
architecture behav of pkg_fft_output_regslice_obuf is
    constant ap_const_logic_1 : STD_LOGIC := '1';
    constant ap_const_logic_0 : STD_LOGIC := '0';
